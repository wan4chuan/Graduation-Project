...
<%
	...
	List list=news.getOneFiles(Integer.parseInt(id));
...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		<TR>
          <TD  align=center>
		  发布人：<%=list.get(4).toString() %> 发布时间：<%=list.get(5).toString() %> 
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
		  下 载：<a href="down.jsp?url=<%=list.get(2).toString()%>"> 点击下载</a> 
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
