...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TABLE width="100%" border="0" align="center"style="cursor:hand" onclick=javascript:expand(1)>
    ...
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/info/editpwd.jsp" target="MainFrame">修改登陆密码</a></TD></TR>
    </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/info/<%=url %>" target="MainFrame">修改详细资料</a>
</TD></TR>
  </TABLE>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/info/files.jsp" target="MainFrame">上传文件管理</a></TD></TR>
  </TABLE>
   </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %>member/images/menu.gif" align=absMiddle><a href="<%=basePath %>member/info/add.jsp?method=addfiles" target="MainFrame">我要上传文件</a>
  </TABLE>
  </TD>
  </TR>
  </TABLE>
