     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		<TD  class=middle align="left" >
               <TABLE class=xsnr id=tb1_nr1  cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TBODY>
                    <TR>
          <TD  align=left><font color=blue><strong>新闻标题</strong></font></TD>
		  <TD align=center><font color=blue><strong>发布人</strong></font> </TD>
        ...
        <TR>
		  ...
		  <TD align=center><%=allnew.get(2).toString()%> </TD>
		  <TD align=right><%=allnew.get(3).toString()%> </TD>
		</TR>
		<%}} %>
				</TBODY>
			</TABLE>			
