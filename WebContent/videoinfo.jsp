...
<%
	...
	List list=news.getOneVideo(Integer.parseInt(id));
...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		<TR>
          <TD  align=center>
		  发布人：<%=list.get(9).toString() %> 发布时间：<%=list.get(10).toString() %> 
		   </TD>
		</TR>
		<TR>
		<TR>
          <TD  align=center>
		  <embed src="<%=list.get(7).toString()%>" width="500" height="350" autostart="true" ></embed>
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
		  产地：<%=list.get(3).toString()%> 
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
		  导演：<%=list.get(4).toString()%> 
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
		  主演：<%=list.get(5).toString()%> 
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
		  片长：<%=list.get(6).toString()%> 
		   </TD>
		</TR>
		<TR>
          <TD  align=center>
